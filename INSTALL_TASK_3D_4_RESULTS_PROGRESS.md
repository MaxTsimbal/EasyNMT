...
This package is an overlay for the current `EasyNMT_Public` project that already contains Task 3D.3.
...
$zip = Get-ChildItem "$env:USERPROFILE\Downloads\EasyNMT_Task3D_4_RESULTS_PROGRESS_SYNC_READY*.zip" |
...
$temp = Join-Path $env:TEMP "EasyNMT_Task3D_4_ResultsProgress"
