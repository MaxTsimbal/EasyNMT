...
Dashboard v0.9.8 перебудовано: компактний перший екран, нормальна сітка без порожніх областей, адаптивна бічна панель, читабельні уроки та постійна кнопка Easy.
