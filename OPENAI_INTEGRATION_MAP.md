...
Під час старту `EasyNMT v1.0 Beta` не потрібно знову перебудовувати чат. Потрібно тестувати промпти, моделі, ціну, якість оцінювання та інтеграцію AI в уроки й тести.
