...
## v0.9.9.5 Google OAuth Final Fix
- Прибрано залежність Google-входу від Authlib.
- Додано прямий Authorization Code Flow через Google OAuth 2.0 endpoints.
- Додано захист `state` від підміни запиту.
- Callback автоматично використовує Railway HTTPS URL.
- Додано безпечні діагностичні дані без показу секретів.
- Архів очищено від дубльованої вкладеної копії проєкту.
