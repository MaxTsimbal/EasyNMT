...
## v0.9.9.6 Mobile Clarity

- Повторний вхід через email або Google одразу відкриває кабінет.
- Новий Google-користувач і далі проходить створення персонального плану.
- Додано зрозумілу мобільну панель «Усі розділи».
- Додано нижню мобільну навігацію: Огляд, Сьогодні, Уроки, Easy, Профіль.
- Sidebar отримав помітну кнопку закриття та більші зони натискання.
- Кабінет став компактнішим і читабельнішим на вузьких екранах.
