...
## v0.9.9 — Виправлення 6: Product Redesign

- Кабінет перебудовано у професійний триколонковий інтерфейс: навігація, основний простір і панель рекомендацій.
- Додано новий hero-блок, статистику, маршрут до 200 балів і картки предметів.
- Emoji-піктограми основної навігації замінено на єдину SVG-систему.
- Бренд оновлено до стриманого космічного знака без додаткових растрових ілюстрацій.
- Easy AI приведено до нового продуктового стилю.
- Мобільна версія зберігає sidebar, нижню навігацію та компактне компонування.
- Серверна логіка, Google OAuth, база даних, прогрес, XP і розблокування не змінювалися.
